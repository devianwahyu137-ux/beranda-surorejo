      ...
      <div className="container-page">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 md:mb-12">
          <ScrollReveal direction="up">
            ...
            <div className="md:hidden inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-full bg-primary-50 text-primary-700 font-bold text-xs animate-pulse mt-3 border border-primary-200/80 shadow-sm">
